...
@EnableJpaRepositories(basePackages = "ru.iu3.motherland.repository")
public class DataConfig {
    ...
    private static final String PROP_HIBERNATE_DIALECT = "db.spring.jpa.properties.hibernate.dialect";
